...
{
    public static final int BLOCK_SIDE = 20;
    ...
    public void draw(Graphics g)
    {
        for(int i = 0; i < blocks.length; i++)
        {
            for(int j = 0; j < blocks[0].length; j++)
            {
                ...
                g.fillRect(i*BLOCK_SIDE, j*BLOCK_SIDE, BLOCK_SIDE, BLOCK_SIDE);
                g.setColor(Color.LIGHT_GRAY);
                g.drawRect(i*BLOCK_SIDE, j*BLOCK_SIDE, BLOCK_SIDE, BLOCK_SIDE);
            }
        }
    }
